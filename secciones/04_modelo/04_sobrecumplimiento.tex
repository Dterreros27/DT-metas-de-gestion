...
El hecho de que \(Q^{B^{+}}\geq Q^{B}\) no implica, por sí solo, que \(B^{+}\) domine a \(B\). La desigualdad \eqref{eq:condicion_bienestar_bplus} es la descomposición contable de esa comparación: el valor del sobrecumplimiento inducido y de cualquier reducción de la carga efectiva de la multa debe superar el costo neto de la bonificación y cualquier incremento del gasto de inversión o de los costos de operación y mantenimiento. Su cumplimiento requiere calibración o evidencia adicional; no se deriva automáticamente del incentivo añadido.
...
La Subsección~4.5 incorpora esta condición a la síntesis comparativa, sin imponer un ordenamiento global de bienestar.
