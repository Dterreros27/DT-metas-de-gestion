...
La Subsección~4.1 formaliza el entorno común a los distintos diseños, la decisión gerencial, las consecuencias del incumplimiento y el criterio del regulador; la Subsección~4.2 especifica los esquemas; la Subsección~4.3 compara sus incentivos, resultados y condiciones de bienestar; la Subsección~4.4 incorpora \(B^{+}\); y la Subsección~4.5 sintetiza los resultados. El análisis constituye un ejercicio de estática comparada entre diseños dados: no determina un diseño globalmente óptimo ni desarrolla una estructura dinámica completa.
